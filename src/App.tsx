...
export default function App() {
  ...
  return (
    ...
    >
      <audio ref={audioRef} src="/Heeriye (Flute Cover) Flute Siva Jasleen Royal Arijit Singh Dulquer Salmaan Don Stewart.mp3" preload="auto" />
      ...
      >
        <motion.div
          ...
          className="text-center space-y-4 md:space-y-8 mt-4 md:mt-12 bg-paper/85 backdrop-blur-md p-8 pt-16 md:p-16 md:pt-24 rounded-t-[12rem] md:rounded-t-[20rem] rounded-b-[3rem] border border-sage/20 shadow-2xl max-w-5xl mx-auto relative overflow-hidden"
        >
          <motion.div
                ...
                <div className="w-full h-full relative group">
                  ...
                  <div className="absolute top-6 right-6 md:top-10 md:right-10 bg-white/60 backdrop-blur-md p-4 md:p-8 border border-white/60 rounded-2xl group-hover:bg-white/80 transition-all duration-700 shadow-xl">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => window.open("https://maps.app.goo.gl/DhaoyvZFQbyjCj2Z6?g_st=ic", "_blank")}
                ...
                <div className="w-full h-full flex flex-col justify-center items-center px-4 md:px-8">
                  ...
                  <div className="w-full max-w-sm space-y-4 md:space-y-6 text-left">
                    ...
                    <div className="flex items-start gap-2 md:gap-4">
                      ...
                      <div>
                        <p className="text-[12px] md:text-sm font-bold uppercase tracking-wider">Lunch Buffet</p>
                      </div>
                    </div>
        ...
        >
          <p className="serif text-sm md:text-base uppercase tracking-[0.4em] text-sage/50">Moments Together</p>
          <h3 className="serif text-3xl md:text-5xl text-sage font-medium">Our Gallery</h3>
          <div className="w-16 h-px bg-sage/30 mx-auto" />
        </motion.div>
